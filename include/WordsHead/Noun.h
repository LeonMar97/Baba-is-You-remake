...
public:
	...
	virtual  void fillAttributes(std::shared_ptr<CollisionStrategy>&);
	virtual  void removeAttribute(std::shared_ptr<CollisionStrategy>&);//might be deleted later
	...
	virtual CollisionStrategySet& getStaticRepresentation() = 0;
